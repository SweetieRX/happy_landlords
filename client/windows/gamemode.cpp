    ...
    , ui(new Ui::GameMode)
{
    ...
    connect(comm, &Communication::startGame, this, [=](QByteArray msg){
        ...
        connect(panel, &GamePanel::panelClose, this, [=](){
            show();
    ...
    connect(ui->manualBtn, &QPushButton::clicked, this, [=](){
        auto room = new JoinRoom(DialogType::Manual, this);
        room->setWindowTitle("创建房间");
        connect(room, &JoinRoom::leaveRoom, this, [=](){
            ui->information->setText("");
        });
        room->exec();
    });
    connect(ui->searchBtn, &QPushButton::clicked, this, [=](){
        auto room = new JoinRoom(DialogType::Search, this);
