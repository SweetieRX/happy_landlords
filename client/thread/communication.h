...
signals:
    ...
    void loginOk();
    void registerOk();
    void aesFailed(QByteArray msg);
    void registerFailed(QByteArray msg);
    void loginFailed(QByteArray msg);
    void joinRoomFailed(QByteArray msg);
    void playerCount(int number);
    void startGame(QByteArray msg);
    void roomExist(bool);
    void somebodyLeave(int count);
    void reDispatchCard(QByteArray msg);
