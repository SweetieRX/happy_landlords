...
void Communication::parseRecvMessage()
{
    ...
    {
        int bet = ptr->data1.toInt();
        qDebug() << "+++++++++++发送来的倍率是："  << bet;
        BetQueue::getInstance()->add(bet);
        break;
    }
    ...
    case RespondCode::ReDispatchCardOk:
        emit reDispatchCard(ptr->data1);
        break;
    case RespondCode::AesFailed:
        emit aesFailed(ptr->data1);
        break;
    case RespondCode::RegisterFailed:
        emit registerFailed(ptr->data1);
        break;
    case RespondCode::LoginFailed:
        emit loginFailed(ptr->data1);
        break;
    case RespondCode::JoinRoomFailed:
        emit joinRoomFailed(ptr->data1);
        break;
    default:
        break;
    }
